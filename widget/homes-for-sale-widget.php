...
//---------------------------------------------------------------
class tvds_homes_for_sale_widget extends WP_Widget
{
    // Construct function.
	//---------------------------------------------------------------
    function __construct(){
        ...
        // Base ID of your widget
            ...
            __('Huizen te koop widget', 'tvds'),

            // Widget description
            array('description' => __('Te koop huizen in een widget', 'tvds'),)
        );
    }
				...
				while($favorite_query->have_posts()) : $favorite_query->the_post();
					...
					echo '<div class="tvds_homes_favorite_widget_row">';
						...
						echo '<div class="tvds_homes_favorite_widget_content">';
							...
							echo '<div><strong>€ '.get_post_meta($post->ID, 'sale_price', true).'</strong></div>';
							
							echo '<a href="'.get_the_permalink().'" class="tvds_homes_btn small">'.__('Details', 'tvds').'</a>';
